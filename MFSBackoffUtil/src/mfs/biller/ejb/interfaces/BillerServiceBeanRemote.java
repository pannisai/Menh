...
@Remote
public interface BillerServiceBeanRemote {
	
	//public static final String JNDI_WEBLOGIC = "mfs.biller.ejb.BillerServiceBean#mfs.biller.ejb.interfaces.BillerServiceBeanRemote";
	//public static final String JNDI_WEBLOGIC = "java:global/BillerInquiryWeb/BillerServiceBean!mfs.biller.ejb.interfaces.BillerServiceBeanRemote";
