...
@Entity
@Table(name = "BANK_SYSTEM_MAINTENANCE")
@Cache(type = CacheType.NONE)
public class BankSystemMATN implements Serializable {

	private static final long serialVersionUID = 8579857350638371446L;

	@Id
	@Column(name = "BANK_SYSM_MATN_ID")
	private Integer BANK_SYSM_MATN_ID;

	@Column(name = "BANK_SRVC_ID")
	private Integer BANK_SRVC_ID;

	@Column(name = "BANK_STAR_TIME")
	private Integer BANK_STAR_TIME;

	@Column(name = "BANK_END_TIME")
	private Integer BANK_END_TIME;

	@Column(name = "BANK_SYSM_MATN_NAME")
