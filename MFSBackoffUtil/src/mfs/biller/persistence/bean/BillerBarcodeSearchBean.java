...
public class BillerBarcodeSearchBean implements Serializable{
	/**
	 * 
	 */
	...
	public String toString() {
		return "BillerBarcodeSearchBean [BARC_ID=" + BARC_ID + ", BARC_NAME="
				+ BARC_NAME + ", BARC_CRRG_RETN_FLAG=" + BARC_CRRG_RETN_FLAG
				+ ", BARC_PERF_FLAG=" + BARC_PERF_FLAG + ", BARC_PERF_VALUE="
				+ BARC_PERF_VALUE + ", BARC_LINE_MAX=" + BARC_LINE_MAX
				+ ", BARC_EFFT_DATE=" + BARC_EFFT_DATE + ", BARC_LINE_NO="
				+ BARC_LINE_NO + ", BLLR_SRVC_ID=" + BLLR_SRVC_ID
				+ ", BARC_NEW_LINE_POST=" + BARC_NEW_LINE_POST
				+ ", BARC_SRVC_CODE=" + BARC_SRVC_CODE + ", ACT_FLAG="
				+ ACT_FLAG + ", CRTD_BY=" + CRTD_BY + ", CRTD_DTTM="
				+ CRTD_DTTM + ", LAST_CHNG_BY=" + LAST_CHNG_BY
				+ ", LAST_CHNG_DTTM=" + LAST_CHNG_DTTM + ", BARC_TYPE="
				+ BARC_TYPE + ", BARC_EXPR_DATE=" + BARC_EXPR_DATE
				+ ", BLLR_SRVC_NAME_EN=" + BLLR_SRVC_NAME_EN + "]";
	}
	public BillerBarcodeSearchBean() {
		super();
	}
