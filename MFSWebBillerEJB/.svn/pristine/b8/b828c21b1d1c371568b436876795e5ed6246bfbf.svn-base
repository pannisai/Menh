...
@Local
public interface DropdownlistLocal {
	public static final String JNDI_WEBLOGIC = "mfs.biller.ejb.Dropdownlist#mfs.biller.session.stateless.DropdownlistRemote";
